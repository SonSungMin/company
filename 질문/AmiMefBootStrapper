    ...
    public class AmiMefBootStrapper : MefBootstrapper
    {
        ...
        protected override void ConfigureAggregateCatalog()
        {
            try
            {
                ...
                //this.AggregateCatalog.Catalogs.Add(new DirectoryCatalog("HHIProjectPlanOrg"));
                //this.AggregateCatalog.Catalogs.Add(new DirectoryCatalog("HHIExecPlan"));
                //AssemblyCatalog
                //PrismSupporter.AddCatalogFromAssembly(this.AggregateCatalog, "BarManagerModuleMEF.dll");
            }            
